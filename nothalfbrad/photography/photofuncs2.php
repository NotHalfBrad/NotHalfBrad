...
function readifyURL($string) 
{ return str_replace(' ', '_', $string); }

function dereadifyURL($string) 
{ return str_replace('_', ' ', $string); }

function FBreadifyURL($string)
...
function getPhotographyURL(){return 'https://www.NotHalfBrad.com/photography';}
...
function getThumbFolder($album_name){
    return getAlbumFolder($album_name).'thumbs/';}
...
function getReducedFolder($album_name){
    return getAlbumFolder($album_name).'reduced/';}
...
function getImageID($images, $image_name){
	return array_search($image_name, $images);
}
