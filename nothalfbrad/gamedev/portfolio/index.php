...
echo '<div class="font-body color-body datacard-frame shadow" style="width:100%;">
			 <div class="datacard-content no-min">
			 	<b>This page is only currently built for viewing in landscape (apologies!).<br>
			 	I\'m working on it! Try rotating your screen, if you are viewing on a cellphone!</b>
			 </div>
		</div>';
...
$intro = '<!--<span class="font-datacard-title datacard-content">Introduction</span><br>-->
		<table cellpadding=0 cellspacing=0><tr><td>
			...
			<div class="datacard-content font-body" style="width:40vw; max-width:600px; margin:0px 70px 0px 70px;"><span style="line-height:0.1;">An introduction to</span><br>
			<span class="font-datacard-title">'.$data['intro']['title'].'</span><br>
				'.$data['intro']['text'].'<p><br><div style=" width:100%; text-align:center;">'.
				button('Linkedin', "https://www.linkedin.com/in/bradleywiggins/", "color-button-affirm", true, "12em", "4em").
				'&nbsp;&nbsp;&nbsp;&nbsp;'.
				button("Resume", "../resume.php", "color-button-affirm", true, "12em", "4em").'
			</div></div>
		</td></tr></table>';
